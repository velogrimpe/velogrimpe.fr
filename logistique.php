...
<body class="min-h-screen">
  ...
  <main class="max-w-screen-lg mx-auto prose p-4
    ...
    <p> Les TER acceptent <span class="underline">gratuitement</span> les vélos, dans la limite des places
      disponibles... Donc oui, si le TER est blindé, vous ne pourrez pas rentrer avec votre vélo. Ça arrive, mais c’est
      rare. </p>
    <p>Attention :</p>
    <ul>
      <li>Les tandems, fatbikes, vélocargos, remorques ne sont pas toujours autorisés dans les TER.</li>
      <li>Sur certaines lignes, à certaines périodes, une réservation est obligatoire ! C’est par exemple le cas les
        week-ends et jours fériés du 01/05/24 au 29/09/24 sur les lignes Valence-Die-Gap, Lyon- Genève,
        Lyon-Avignon-Marseille, Grenoble-Gap. Pour consulter les conditions d'accueil des vélos dans les TER, vous
        pouvez vous référer au site <a href="https://www.veloabord.fr/">veloabord.fr</a> tenu par la SNCF, qui indique
        en fonction des lignes et de la période si la réservation est nécessaire et/ou payante.</li>
    </ul>
    <p> Les TER ont le plus souvent des wagons prévus pour accrocher les vélos, qui sont généralement indiqués par des
      ...
      déjà joué à Tetris devient alors un avantage certain. </p>
    <p> Il est conseillé d’enlever les sacoches avant de monter dans le train, et de les porter en bandoulière, c’est
      plus pratique. </p>
    <p> Prendre le TGV avec un vélo est plus compliqué : il faut parfois démonter son vélo et/ou le mettre sous housse,
      et c’est parfois payant. </p>
