...
export const landscapeTiles = L.tileLayer(
  "https://{s}.tile.thunderforest.com/landscape/{z}/{x}/{y}.png?apikey=e6b144cfc47a48fd928dad578eb026a6",
  {
    ...
    minZoom: 0,
    attribution:
      '<a href="http://www.thunderforest.com/landscape/" target="_blank">Thunderforest</a>/<a href="http://osm.org/copyright" target="_blank">OSM contributors</a>',
    crossOrigin: true,
  },
);
export const opencyclemapTiles = L.tileLayer(
