...
<body class="min-h-screen">
  ...
  <div class="max-w-screen-lg mx-auto prose p-4
    ...
    <p>C'est par cette question que Florent a commencé le projet vélogrimpe, en mai 2024.
      D'un document Word perso à un PDF en libre accès, nous voici maintenant avec un site web dont le but est de
      donner envie
    ...
    <p>
      Merci à tous les contributeurs ! Louenn, Zoé, Denise, Alan, Bastien, Clément, Guillaume, Fanny...
      Merci à Mélanie pour son logo, Natacha pour affiche ! Et puis merci à tous les partenaires de sorties vélogrimpe,
      et à tous ceux dont
