...
<body class="min-h-screen">
  ...
  <div class="toast hidden" id="confirmationMessage">
    <div class="alert alert-success text-base-100" role="alert">
      <span>
  ...
  <main class="max-w-screen-xl mx-auto flex flex-col gap-2 md:gap-4 p-4">
